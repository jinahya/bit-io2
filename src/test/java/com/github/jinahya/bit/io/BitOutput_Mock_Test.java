...
class BitOutput_Mock_Test {
    ...
    class WriteBooleanTest {
        ...
        @Test
        void readBoolean__() {
            assertThatCode(() -> output.writeBoolean(current().nextBoolean())).doesNotThrowAnyException();
        }
    }
    ...
    class WriteByteTest {
        ...
        void writeByte__(final boolean unsigned) throws IOException {
            ...
            assertThatCode(() -> output.writeByte(unsigned, size, value)).doesNotThrowAnyException();
            verify(output, times(1)).writeInt(unsigned, size, value);
        }
    }

    @DisplayName("writeShort")
    @Nested
    class WriteShortTest {
        ...
        void writeShort__(final boolean unsigned) throws IOException {
            ...
            assertThatCode(() -> output.writeShort(unsigned, size, value)).doesNotThrowAnyException();
            verify(output, times(1)).writeInt(unsigned, size, value);
        }
    }
    ...
    class WriteIntTest {
        ...
        void writeInt__(final boolean unsigned) throws IOException {
            ...
            assertThatCode(() -> output.writeInt(unsigned, size, value)).doesNotThrowAnyException();
        }
    }
    ...
    class WriteLongTest {
        ...
        void writeLong__(final boolean unsigned) throws IOException {
            ...
            assertThatCode(() -> output.writeLong(unsigned, size, value)).doesNotThrowAnyException();
        }
    }

    @DisplayName("writeChar")
    @Nested
    class WriteCharTest {
        ...
        void writeChar__() throws IOException {
            ...
            assertThatCode(() -> output.writeChar(size, value)).doesNotThrowAnyException();
            verify(output, times(1)).writeInt(true, size, value);
        }
    }
