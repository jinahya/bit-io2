...
/**
 * A class for testing {@link FloatWriter.CompressedZero#getInstanceNullable()}.
 *
 * @author Jin Kwon &lt;onacit_at_gmail.com&gt;
 */
@Slf4j
class FloatWriter_CompressedZeroNullable_Test
        extends BitWriterTest<FloatWriter.CompressedZero, Float> {

    FloatWriter_CompressedZeroNullable_Test() {
        super(FloatWriter.CompressedZero.class, Float.class);
    }

    @Test
    void nullable_UnsupportedOperationException_() {
        final var instance = FloatWriter.CompressedZero.getInstanceNullable();
